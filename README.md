...
Il progetto è il risutato di un percorso di studi di 6 mesi con Boolean Careers tramite cui è stato possibile mettere in pratica le seguenti tecnologie: 
- HTML
- SCSS/SASS
- JAVASCRIPT/JQUERY
- PHP
